...
public class CaesarCipher 
{
    ...
    public CaesarCipher(int key) 
    {
        ...
        alphabet = alphabet + alphabet.toLowerCase();  //To build the alphabet including uppercase letters and lowercase letters
        shiftedAlphabet = shiftedAlphabet + shiftedAlphabet.toLowerCase();  //To build the shiftedAlphabet including uppercase letters and lowercase letters
    }
